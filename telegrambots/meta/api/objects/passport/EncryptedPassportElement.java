...
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile;
...
public class EncryptedPassportElement implements BotApiObject {
    ...
    private List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile> files;
    /**
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile frontSide;
    /**
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile reverseSide;
    /**
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile selfie;
    /**
    ...
    private ArrayList<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile> translations;
    /**
    ...
    public EncryptedPassportElement(String type, String data, String phoneNumber, String email, List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile> files,
                                    james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile frontSide, james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile reverseSide, james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile selfie) {
        this.type = type;
        this.data = data;
    ...
    public List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile> getFiles() {
        return files;
    }

    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile getFrontSide() {
        return frontSide;
    }

    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile getReverseSide() {
        return reverseSide;
    }

    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportFile getSelfie() {
        return selfie;
    }
