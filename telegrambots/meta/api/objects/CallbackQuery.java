...
public class CallbackQuery implements BotApiObject {
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User from; ///< Sender
    /**
     * Optional.
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Message message;
