...
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Audio;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Chat;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Contact;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Dice;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Document;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.EntityType;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Location;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.MessageEntity;
...
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Venue;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Video;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.VideoNote;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Voice;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.games.Animation;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.games.Game;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.passport.PassportData;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.Invoice;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.SuccessfulPayment;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.polls.Poll;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.replykeyboard.InlineKeyboardMarkup;
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.stickers.Sticker;
...
public class Message implements BotApiObject {
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User from; ///< Optional. Sender, can be empty for messages sent to channels
    @JsonProperty(DATE_FIELD)
    private Integer date; ///< Optional. Date the message was sent in Unix time
    @JsonProperty(CHAT_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Chat chat; ///< Conversation the message belongs to
    @JsonProperty(FORWARDFROM_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User forwardFrom; ///< Optional. For forwarded messages, sender of the original message
    @JsonProperty(FORWARDFROMCHAT_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Chat forwardFromChat; ///< Optional. For messages forwarded from a channel, information about the original channel
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Audio audio; ///< Optional. Message is an audio file, information about the file
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Video video; ///< Optional. Message is a video, information about the video
    @JsonProperty(CONTACT_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Contact contact; ///< Optional. Message is a shared contact, information about the contact
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Venue venue; ///< Optional. Message is a venue, information about the venue
    /**
    ...
    private List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User> newChatMembers; ///< Optional. New members were added to the group or supergroup, information about them (the bot itself may be one of these members)
    @JsonProperty(LEFTCHATMEMBER_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User leftChatMember; ///< Optional. A member was removed from the group, information about them (this member may be bot itself)
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Voice voice; ///< Optional. Message is a voice message, information about the file
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Dice dice; // Optional. Message is a dice with random value from 1 to 6
    @JsonProperty(VIABOT_FIELD)
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User viaBot; // Optional. Bot through which the message was sent
    public Message() {
        super();
    }
    ...
    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User getFrom() {
        return from;
    }
    ...
    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.Chat getChat() {
        return chat;
    }

    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User getForwardFrom() {
        return forwardFrom;
    }
    ...
    public List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User> getNewChatMembers() {
        return newChatMembers == null ? new ArrayList<>() : newChatMembers;
    }

    public james_gosling.projects.balebotmg.telegrambots.meta.api.objects.User getLeftChatMember() {
