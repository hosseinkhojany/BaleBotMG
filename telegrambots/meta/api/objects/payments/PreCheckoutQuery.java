...
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.OrderInfo;
...
public class PreCheckoutQuery implements BotApiObject {
    ...
    private james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.OrderInfo orderInfo; ///< Optional. Order info provided by the user
