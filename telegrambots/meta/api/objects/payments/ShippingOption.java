package james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments;
...
import james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.LabeledPrice;
...
public class ShippingOption implements InputBotApiObject, Validable {
    ...
    private List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.LabeledPrice> prices; ///< List of price portions
     ...
     */
    public ShippingOption(String id, String title, List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.LabeledPrice> prices) {
    ...
    public List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.LabeledPrice> getPrices() {
        return prices;
    }

    public ShippingOption setPrices(List<james_gosling.projects.balebotmg.telegrambots.meta.api.objects.payments.LabeledPrice> prices) {
        this.prices = checkNotNull(prices);
        return this;
    }
