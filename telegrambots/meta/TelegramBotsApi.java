package james_gosling.projects.balebotmg.telegrambots.meta;
...
public class TelegramBotsApi {
    ...
    public TelegramBotsApi(String externalUrl, String internalUrl) throws TelegramApiRequestException {
        ...
        webhook = james_gosling.projects.balebotmg.telegrambots.meta.ApiContext.getInstance(Webhook.class);
